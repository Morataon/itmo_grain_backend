import 'dart:convert';
import 'package:itmo_grain_backend/auth.dart';
import 'package:itmo_grain_backend/game.dart';
import 'package:itmo_grain_backend/questions.dart';
import 'package:itmo_grain_backend/teams.dart';
...
void main(List<String> arguments)async {
  ...
  router.post('/teamGames', (Request request) async {
    var json = await request.readAsString();
    var data = await jsonDecode(json);
    List response = await  getTeamGames(sql,data['id']);
    return Response.ok(jsonEncode(response));
  });
  router.post('/getTeamInfo', (Request request) async {
    var json = await request.readAsString();
    var data = await jsonDecode(json);
